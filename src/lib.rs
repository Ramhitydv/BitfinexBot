...
#[derive(Debug)]
pub struct BitfinexBotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BitfinexBotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BitfinexBot processing");
    
    let mut processor = BitfinexBotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BitfinexBotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BitfinexBotProcessor::new(false);
